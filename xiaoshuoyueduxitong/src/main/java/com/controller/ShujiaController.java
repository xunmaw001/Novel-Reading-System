    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(shujia !=null){
            ...
            BeanUtils.copyProperties( shujia , view );//把实体数据重构到view中
                ...
                //级联表
                XiaoshuoEntity xiaoshuo = xiaoshuoService.selectById(shujia.getXiaoshuoId());
                if(xiaoshuo != null){
    ...
    */
    ...
    public R save(@RequestBody ShujiaEntity shujia, HttpServletRequest request){
        ...
        if(false)
            ...
            shujia.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));

        Wrapper<ShujiaEntity> queryWrapper = new EntityWrapper<ShujiaEntity>()
            .eq("xiaoshuo_id", shujia.getXiaoshuoId())
...
//            shujia.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
    ...
    */
    ...
    public R save( String fileName, HttpServletRequest request){
        ...
        try {
            List<ShujiaEntity> shujiaList = new ArrayList<>();//上传的东西
                ...
                if(!".xls".equals(suffix)){
                    ...
                    if(!file.exists()){
                        ...
                        for(List<String> data:dataList){
                            //循环
                            ShujiaEntity shujiaEntity = new ShujiaEntity();
//                            shujiaEntity.setXiaoshuoId(Integer.valueOf(data.get(0)));   //小说 要改的
//                            shujiaEntity.setYonghuId(Integer.valueOf(data.get(0)));   //用户 要改的
//                            shujiaEntity.setInsertTime(date);//时间
//                            shujiaEntity.setCreateTime(date);//时间
                            shujiaList.add(shujiaEntity);
                        ...
                        //查询是否重复
                        shujiaService.insertBatch(shujiaList);
                        return R.ok();
                    }
                }
            }
