...
//                            xiaoshuoLiuyanEntity.setXiaoshuoId(Integer.valueOf(data.get(0)));   //作品 要改的
//                            xiaoshuoLiuyanEntity.setYonghuId(Integer.valueOf(data.get(0)));   //用户 要改的
//                            xiaoshuoLiuyanEntity.setXiaoshuoLiuyanText(data.get(0));                    //评论内容 要改的
//                            xiaoshuoLiuyanEntity.setInsertTime(date);//时间
//                            xiaoshuoLiuyanEntity.setReplyText(data.get(0));                    //回复内容 要改的
//                            xiaoshuoLiuyanEntity.setUpdateTime(sdf.parse(data.get(0)));          //回复时间 要改的
