        ...
        <form class="app-update-pv">
			<view
                ...
                <textarea
                        ...
                        v-model='ruleForm.xiaoshuoLiuyanText' placeholder="评论内容"></textarea>
            </view>
    ...
    export default {
        ...
        async onLoad(options) {
            ...
            if (options.id) {
                ...
                // 获取信息
                let res = await this.$api.info(`xiaoshuoLiuyan`, this.ruleForm.id);
        ...
        methods: {
            ...
            async onSubmitTap() {
			if ((!this.ruleForm.xiaoshuoLiuyanText)) {
                this.$utils.msg(`评论内容不能为空`);
                return
            }
                if (this.ruleForm.id) {
                    await this.$api.update(`xiaoshuoLiuyan`, this.ruleForm);
                } else {
                    await this.$api.save(`xiaoshuoLiuyan`, this.ruleForm);
                }
