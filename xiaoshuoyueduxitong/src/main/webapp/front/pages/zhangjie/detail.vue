                ...
                <view class="detail-content">
                    <view class="detail-list-item"
                        ...
                        <view class="lable"
                            ...
                            标题：</view>
                        <view class="text" :style='{"color":"#333","textAlign":"left","fontSize":"28rpx"}'>{{detail.zhangjieName}}
                        </view>
                    </view>
                </view>
                <view class="time-content"
                    ...
                    <view class="content" :style='{"color":"#333","fontSize":"28rpx"}'>
                        <rich-text style="font-size: 33upx;line-height: 50upx;letter-spacing: 5upx;"
                                   :nodes="detail.zhangjieContent"></rich-text>
                    </view>
                </view>
            </view>
...
<script>
	export default {
		...
		methods: {
			...
			// 获取详情
			async init() {
				let res = await this.$api.info('zhangjie', this.id);
				this.detail = res.data;
				// 主图
				this.swiperList = this.detail.zhangjiePhoto ? this.detail.zhangjiePhoto.split(",") : [];
			},
